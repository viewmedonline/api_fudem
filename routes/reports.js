  ...
  async (request, response) => {
    let datos = [
      [
        ...
        "RX Final Lentes de Contacto OD Adicion",
        ...
        "RX Final Lentes de Contacto OI Adicion",
      ...
      for (const x of results) {
        try {
          ...
          datos.push([
            ...
            x.objOptometrist.data.rxFinalLentesContacto.ojoDer.add,
            ...
            x.objOptometrist.data.rxFinalLentesContacto.ojoIzq.add,
